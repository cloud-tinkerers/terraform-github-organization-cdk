...
namespace github
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/github/r/actions_organization_secret github_actions_organization_secret}.</summary>
    [JsiiClass(nativeType: typeof(github.ActionsOrganizationSecret), fullyQualifiedName: "github.ActionsOrganizationSecret", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"github.ActionsOrganizationSecretConfig\"}}]")]
    public class ActionsOrganizationSecret : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/github/r/actions_organization_secret github_actions_organization_secret} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public ActionsOrganizationSecret(Constructs.Construct scope, string id, github.IActionsOrganizationSecretConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected ActionsOrganizationSecret(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ActionsOrganizationSecret(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(github.ActionsOrganizationSecret))!;
